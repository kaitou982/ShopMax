...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'user/favorites', name: 'MyFavorites', component: () => import('@/pages/user/favorites.vue'), meta: { title: '我的收藏' } },
      ...
      { path: 'new-product', name: 'NewProduct', component: () => import('@/pages/new-product/index.vue'), meta: { title: '新品首发' } },
